          ...
          <form className="px-5 pb-5 pt-3 lg:pb-10 lg:pt-5 lg:px-10 text-black w-full">
            ...
            <div className="space-y-4">
              <div className="w-full flex gap-3">
                <input
                  className="capitalize bg-slate-300 rounded-md shadow-2xl p-3 ex w-full outline-none focus:border-solid focus:border-[1px] "
                  type="text"
                ...
                />
                <input
                  className="p-3 bg-slate-300 rounded-md capitalize shadow-2xl  glass w-full  outline-none focus:border-solid focus:border-[1px]"
                  type="text"
              ...
              <div className="w-full flex gap-3">
                ...
                <input
                  className="capitalize bg-slate-300 rounded-md shadow-2xl p-2 ex w-full outline-none focus:border-solid focus:border-[1px]"
                  type="file"
                ...
                <input
                  className="p-2 bg-slate-300 rounded-md capitalize shadow-2xl  glass w-full  outline-none focus:border-solid focus:border-[1px] "
                  type="file"
